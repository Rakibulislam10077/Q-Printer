        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
            ...
            <View style={productDetailsStyle.highLightedInfo}>
              ...
              {highLightedInfo.map((i) => {
                return (
                  ...
                  >
                    <View
                      style={productDetailsStyle.highLightedInfoItemLogoCon}
                    >
                      <Image
                ...
                <Animated.View entering={FadeInRight.delay(100).duration(500)}>
                  <View style={productDetailsStyle.navigationContainer}>
                    <TouchableOpacity
                      ...
                      onPress={() => setIndex(0)}
                    >
                      <Text style={productDetailsStyle.specTitle}>Specification</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={[
                        index === 1
          ...
          <View style={productDetailsStyle.BuyNowButtonAndPriceContainer}>
            ...
            <View style={productDetailsStyle.buyButtonAndCartCon}>
              ...
              <TouchableOpacity style={productDetailsStyle.cartButton}>
                <CartIcon />
              </TouchableOpacity>
            </View>
          </View>
