...
const BrandDetails = (props: any) => {
  ...
  return (
    <SafeAreaView style={brandDetailsStyle.container}>
      ...
      <View style={brandDetailsStyle.brandSpecCon}>
        <View style={brandDetailsStyle.brandLogoAndNameCon}>
         ...
         <Text style={brandDetailsStyle.brandName}>Canon</Text>
          <Text style={brandDetailsStyle.availableText}>25 Product Availalbe</Text>
         </View>
        </View>
        <TouchableOpacity activeOpacity={.7} style={brandDetailsStyle.favCon}>
          <FavIcon/>
        </TouchableOpacity>
      </View>
      <View style={{flex: 1, }}>
